...
class TrainingArguments(transformers.TrainingArguments):
        ...
        fsdp_config (`str` or `dict`, *optional*):
            ...
            A List of config and its options:
                - min_num_params (`int`, *optional*, defaults to `0`):
                    ...
                    passed).
                - offload ('bool', *optional*, default to 'None')
                    This configures CPU offloading. If this is set to ``None``, then
                    no CPU offloading happens.
    ...
    def __post_init__(self):
        ...
        if self.pipe is None:
            self.pipe = False
        # if self.pipe:
        #     self.parallel_mode = transformers.training_args.ParallelMode.DISTRIBUTED
        ...
        #     self.pipe_config['splits'] = self.n_gpu
